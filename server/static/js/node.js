...
Event.prototype.paint = function(options){
	...
	svg.text(svggroup, 4,this.height-8, "N", {'font-family':'Sans','font-size':8,'cursor':'text','stroke-width':0.1,'id':'noderepeat'})
	...
	svg.image(svggroup, 0,1, 16,16,"img/ok.png",{'id':'nodeonoff'+this.id})
